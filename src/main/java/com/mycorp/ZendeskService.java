...
public class ZendeskService {
    ...
    public String ZENDESK_ERROR_MAIL_FUNCIONALIDAD = "0";
    ...
    public String altaTicketZendesk(UsuarioAlta usuarioAlta, String userAgent){
        ...
        if(StringUtils.isNotBlank(usuarioAlta.getNumTarjeta())){
            try{
            	String dusuario = zendeskHelper.obtenerDatosTarjeta(usuarioAlta);  
        ...
        try
        {
            DatosCliente cliente = zendeskHelper.obtenerDatosCliente(idCliente);
